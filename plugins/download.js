...
` } ,{ quoted: mek })
  ...
  reply('*📥 𝙐𝙋𝙇𝙊𝘼𝘿𝙀𝘿 𝘽𝙔 𝙃𝘼𝙎𝙃𝙐 𝙈𝘿 𝙊𝙒𝙉𝙀𝙍*')
l(e)
}
})
//=================================APK COMMANDS=====================================
...
const response = await require("undici").fetch(q);
        ...
        reply("*HASHU-MD MEDIAFIRE FILE DOWNLOADING...📥*")
...
await conn.sendMessage(from, { react: { text: '⬆', key: mek.key }})
await conn.sendMessage(from, { video: { url: data.result.dl_link.download_mp4_hd }, mimetype: "video/mp4", caption: `> *POWERED by HASHU-MD*` }, { quoted: mek })
await conn.sendMessage(from, { react: { text: '✔', key: mek.key }})
}catch(e){
await conn.sendMessage(from, { react: { text: `❌`, key: mek.key } })
console.log(e)
...
await conn.sendMessage(from, { react: { text: '⬆', key: mek.key }})
await conn.sendMessage(from, { document: { url: data.result.dl_link.download_mp4_hd }, mimetype: "video/mp4", fileName: `${data.result.title}.mp4`, caption: "💻 *HASHU MD TTDL*" }, { quoted: mek }); 
await conn.sendMessage(from, { react: { text: '✔', key: mek.key }})
}catch(e){
await conn.sendMessage(from, { react: { text: `❌`, key: mek.key } })
console.log(e)
...
await conn.sendMessage(from, { react: { text: '⬆', key: mek.key }})
await conn.sendMessage(from, { video: { url: data.result.dl_link.download_mp4_1}, mimetype: "video/mp4", caption: `> *POWERED by HASHU-MD*` }, { quoted: mek })
await conn.sendMessage(from, { react: { text: '✔', key: mek.key }})
}catch(e){
await conn.sendMessage(from, { react: { text: `❌`, key: mek.key } })
console.log(e)
...
await conn.sendMessage(from, { react: { text: '⬆', key: mek.key }})
await conn.sendMessage(from, { document: { url: data.result.dl_link.download_mp4_1 }, mimetype: "video/mp4", fileName: `${data.result.title}.mp4`, caption: "💻 *HASHU MD TTDL*" }, { quoted: mek }); 
await conn.sendMessage(from, { react: { text: '✔', key: mek.key }})
}catch(e){
await conn.sendMessage(from, { react: { text: `❌`, key: mek.key } })
console.log(e)
...
await conn.sendMessage(from, { react: { text: '⬆', key: mek.key }})
await conn.sendMessage(from, { video: { url: data.result.dl_link.download_mp4_2 }, mimetype: "video/mp4", caption: `> *POWERED by HASHU-MD*` }, { quoted: mek })  
await conn.sendMessage(from, { react: { text: '✔', key: mek.key }})
}catch(e){
await conn.sendMessage(from, { react: { text: `❌`, key: mek.key } })
console.log(e)
...
await conn.sendMessage(from, { react: { text: '⬆', key: mek.key }})
await conn.sendMessage(from, { document: { url: data.result.dl_link.download_mp4_2 }, mimetype: "video/mp4", fileName: `${data.result.title}.mp4`, caption: "💻 *HASHU MD TTDL*" }, { quoted: mek }); 
await conn.sendMessage(from, { react: { text: '✔', key: mek.key }})
}catch(e){
await conn.sendMessage(from, { react: { text: `❌`, key: mek.key } })
console.log(e)
...
await conn.sendMessage(from, { react: { text: '⬆', key: mek.key }})
await conn.sendMessage(from, { document: { url: data.result.dl_link.download_mp3 }, mimetype: "audio/mpeg", fileName: `${data.result.title}.mp3`, caption: "💻 *HASHU MD TTDL*" }, { quoted: mek }); 
await conn.sendMessage(from, { react: { text: '✔', key: mek.key }})
}catch(e){
await conn.sendMessage(from, { react: { text: `❌`, key: mek.key } })
console.log(e)
...
let data = await downloadTiktok(q);	
let msg = `
    🎟️ *HASHU-MD TIKTOK DOWNLOADER* 🎟️
...
let dat = `HASHU MD FB DOWNLOADER
